...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__memory_service__ = __webpack_require__(18);
...
var loginService = function () {
  ...
  function login(credentials) {
    return new Promise(function (resolve, reject) {
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post(baseUrl + '/userdata/userlogin', credentials).then(function (response) {
        if (response.data === true) {
          window.sessionStorage.setItem('loginSuccessMessage', 'You have successfully logged on');
          __WEBPACK_IMPORTED_MODULE_4__memory_service__["a" /* default */].setAuthStatus(true);
          window.location.href = '/home';
        } else {
          __WEBPACK_IMPORTED_MODULE_1_vue_on_toast___default.a.ToastService.pop('error', 'You have not been logged in. This is because of a wrong password or username');
        }
  ...
  function logout() {
    __WEBPACK_IMPORTED_MODULE_4__memory_service__["a" /* default */].setAuthStatus(false);
    window.location.href = '/home';
  }
...
/* harmony default export */ __webpack_exports__["a"] = (loginService);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_40ce4566_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_AppHeader_vue__ = __webpack_require__(25);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_40ce4566_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_AppHeader_vue__["a" /* default */],
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  computed: {
    authStatus: function authStatus() {
      return __WEBPACK_IMPORTED_MODULE_0__app_service_js__["a" /* default */].authStatus();
    }
  }
});
...
var baseUrl = __WEBPACK_IMPORTED_MODULE_1_axios___default.a.defaults.baseURL;
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  created: function created() {
    ...
    __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(baseUrl + '/userData').then(function (response) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_axios__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__app_service_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_on_toast__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_on_toast___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_vue_on_toast__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  computed: {
    authStatus: function authStatus() {
      return __WEBPACK_IMPORTED_MODULE_1__app_service_js__["a" /* default */].authStatus();
    }
  },
  methods: {
    lunchLocationToast: function lunchLocationToast() {
      var random = Math.floor(Math.random() * this.restaurantData.length);
      __WEBPACK_IMPORTED_MODULE_2_vue_on_toast___default.a.ToastService.pop('success', 'Lunch Alert', 'lunch today is at: ' + this.restaurantData[random].restaurantName);
    },
    successfulLoginToast: function successfulLoginToast() {
      if (window.sessionStorage.getItem('loginSuccessMessage') === null) {
        console.log('no authenticated user detected');
      } else {
        __WEBPACK_IMPORTED_MODULE_2_vue_on_toast___default.a.ToastService.pop('success', window.sessionStorage.getItem('loginSuccessMessage'));
    ...
    successfulLogoutToast: function successfulLogoutToast() {
      if (window.sessionStorage.getItem('authStatus') === 'false') {
        __WEBPACK_IMPORTED_MODULE_2_vue_on_toast___default.a.ToastService.pop('success', 'you have been sucessfully logged off');
      } else {
...
var store = new __WEBPACK_IMPORTED_MODULE_1_vuex___default.a.Store({
  ...
  actions: {
    logout: function logout(context) {
      __WEBPACK_IMPORTED_MODULE_2__app_service_js__["a" /* default */].actions.logout();
...
if (typeof window !== 'undefined') {
  document.addEventListener('DOMContentLoaded', function (event) {
    var expiration = window.sessionStorage.getItem('tokenExpiration');
...
/* harmony default export */ __webpack_exports__["a"] = (memoryService);
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_43a61586_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Layout_vue__ = __webpack_require__(31);
function injectStyle (ssrContext) {
var i
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_43a61586_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Layout_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
module.exports.__inject__ = function (context) {
  add("716b205e", content, true, context)
};
...
var add = __webpack_require__(2)
module.exports.__inject__ = function (context) {
  add("45a6eb87", content, true, context)
};
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"app"}},[_c('loading-indicator'),_vm._ssrNode(" "),_c('toast-container'),_vm._ssrNode(" "),_c('app-header'),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"main-section section\">","</section>",[_vm._ssrNode("<div class=\"container content\">","</div>",[_c('router-view')],1)]),_vm._ssrNode(" "),_c('app-footer')],2)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_b53efa10_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Login_vue__ = __webpack_require__(37);
function injectStyle (ssrContext) {
var i
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_b53efa10_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Login_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
var add = __webpack_require__(2)
module.exports.__inject__ = function (context) {
  add("d9728b46", content, true, context)
};
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"login"}},[_vm._ssrNode("<div class=\"card\"><div class=\"login\">"+((_vm.authStatus)?("<div class=\"card-main\">\n        Hello authenticated user!\n        <button class=\"button loginButton\">\n          Logout\n        </button></div>"):("<div><h2 class=\"card-header\">Login</h2> <div class=\"card-main\"><div class=\"field is-horizontal\"><div class=\"field-label is-normal\"><label class=\"label\">Username</label></div> <div class=\"field-body\"><div class=\"field\"><div class=\"control\"><input id=\"loginUserInput\" type=\"text\" placeholder=\"Your username\""+(_vm._ssrAttr("value",(_vm.username)))+" class=\"input\"></div></div></div></div> <div class=\"field is-horizontal\"><div class=\"field-label is-normal\"><label class=\"label\">Password</label></div> <br> <div class=\"field-body\"><div class=\"field\"><div class=\"control\"><input id=\"loginPassInput\" type=\"password\" placeholder=\"Your password\""+(_vm._ssrAttr("value",(_vm.password)))+" class=\"input\"></div></div></div></div> <div class=\"field is-horizontal\"><div class=\"field-label\"></div> <div class=\"field-body\"><div class=\"field\"><div class=\"control\">"+((_vm.authStatus)?("<button class=\"button loginButton\">\n                Logout\n                </button>"):"<!---->")+" <button class=\"button loginButton\">\n                Login\n                </button></div></div></div></div></div></div>"))+"</div></div>")])}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1d7e2e65_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Home_vue__ = __webpack_require__(43);
function injectStyle (ssrContext) {
var i
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1d7e2e65_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Home_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
var add = __webpack_require__(2)
module.exports.__inject__ = function (context) {
  add("309c55be", content, true, context)
};
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1dd89050_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_EditTopFive_vue__ = __webpack_require__(47);
function injectStyle (ssrContext) {
var i
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1dd89050_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_EditTopFive_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
var add = __webpack_require__(2)
module.exports.__inject__ = function (context) {
  add("4baaaaeb", content, true, context)
};
